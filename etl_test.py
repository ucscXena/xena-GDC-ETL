...
"""A test script for pipeline development.

In general, importing data from GDC uses the `XenaDataset` class by defining 3 
properties: `root_dir`, `projects` and `xena_dtypes`. For test purpose, 
`root_dir` is the "gitignore/test/" directory under the same directory as this 
scrip.
"""
