...
METADATA_TEMPLATE = {
    ...
    'allele_cnv_ascat2': 'template.cnv.meta.json',
    'allele_cnv_ascat3':'template.cnv.meta.json',
...
METADATA_VARIABLES = {
    ...
    'allele_cnv_ascat2': {'gdc_type': 'Allele-specific Copy Number Segment (ASCAT2)'},
    'allele_cnv_ascat3': {'gdc_type': 'Allele-specific Copy Number Segment (ASCAT3)'},
    'somaticmutation_wxs': {'gdc_type': 'Ensemble Somatic Variant (WXS)'},
    'somaticmutation_targeted': {'gdc_type': 'Ensemble Somatic Variant (Targeted Sequencing)'},
